...
@Autonomous(name = "testAuto", group = "Auto2022")
...
//        if(pipeline.returnPosition() == 1){
//            encoderDrive(0.25, -2, 2, 2, -2, 2.0);
//        }
//        else if(pipeline.returnPosition() == 2){
//            encoderDrive(0.25, 2, -2, -2, 2, 2.0);
//            encoderDrive(0.25, 6, 6, 6, 6, 2.0);
//        }
//        else{
//            encoderDrive(0.25, 30,30,30,30,4.0);
//        }
...
//        }
    ...
    public static class FrenzyPipeline extends OpenCvPipeline {
        ...
        final int two_high_threshold = 180;
        final int three_low_threshold = 130;
        final int three_high_threshold = 150;
